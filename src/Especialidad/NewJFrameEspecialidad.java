...
public class NewJFrameEspecialidad extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrameEspecialidad
     */
    
    ConexionBD.conexión_postgres CP = new conexión_postgres("postgres", "postgres", "cesar");
    
    public NewJFrameEspecialidad() throws ClassNotFoundException, SQLException {
        initComponents();
        // coloca el frame al centro
    ...
    private void initComponents() {
        ...
        jLblNombre.setText("ID Especialidad");

        jLabel6.setText("Nombre Especialidad");
    ...
    private void bnDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnDatosActionPerformed
        ...
        try {
            ResultSet datos = this.CP.select("*", "\"public\".especialidad", "");
            while (datos.next());
            {
    ...
    private void bnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnBorrarActionPerformed
        ...
        datos = " where \"id_especialidad\" = '" + this.txtIdBorrar.getText() + "'";

        estado = this.CP.Borrar("\"public\".Especialidad", datos);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.CP.insertar("\"public\".Especialidad", datos);
    ...
    private void bnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnModificarActionPerformed
        ...
        datos = "set \"nombre_especialidad\" = '"
        + this.txtApellido1Modificar.getText()
        + "' where \"id_especialidad\" = '"
        + parseString(this.txtIDModificar.getText()) + "'";

        estado = this.CP.Modificar("\"public\".Especialidad", datos);
        System.out.println(estado);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewJFrameEspecialidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new NewJFrameEspecialidad().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(NewJFrameEspecialidad.class.getName()).log(Level.SEVERE, null, ex);
